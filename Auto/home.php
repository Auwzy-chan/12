    ...
    <style>
        ...
        * {
        ...
        .hero {
            ...
            background: linear-gradient(90deg, #05070d 35%, rgba(5, 7, 13, 0.7) 60%, rgba(5, 7, 13, 0.2) 100%),
...
<body>
    ...
    <footer class="site-footer">
        <span>© 2026 Auto Hub • From discovery to financing, every step is streamlined.</span>
